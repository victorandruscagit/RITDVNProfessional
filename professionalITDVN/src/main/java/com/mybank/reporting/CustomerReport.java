        ...
        for (int cust_idx = 0;
            ...
            for (int acct_idx = 0;
                ...
                if (account instanceof SavingAccount) {
                    ...
                    account_params = ", interest rate is "
                            + rateFormat.format(((SavingAccount) account).getInterestRate());
                } else if (account instanceof CheckingAccount) {
                    account_type = "Checking Account";
                    account_params = ", overdraft  amount is "
                            + amountFormat.format(((CheckingAccount) account).getOverdraftAmount());
                } else {
